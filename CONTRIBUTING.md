...
如果你是用 Codex 或其他自动化工具维护仓库，先读根目录 `AGENTS.md`，里面写了生成文件、质量门禁、gpt-image-2 参数和推送后的 CI 检查规则。
...
所有新增角色、模板、Prompt Pack、预览图都必须保持端庄、非低俗、不性感化、不儿童化，不包含真实个人隐私或真实品牌 logo，也不要暗示官方授权或商用授权。
